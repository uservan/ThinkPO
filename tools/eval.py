...
def parse_arguments():
    ...
    parser.add_argument("--model", required=True, type=str, default='bespokelabs/Bespoke-Stratos-7B', help="Path to the model.")
    parser.add_argument("--evals", required=True, type=str, default='MinvervaMath,AIME,MATH500,GPQADiamond,GSM8K,OlympiadBenchMath', help="Comma-separated list of evals to run (no spaces).")
